  ...
  return (
    <div className="relative w-24 h-24 flex items-center justify-center">
      <motion.div
        ...
        style={{
          background:
            "conic-gradient(from 0deg, rgba(34,197,94,0.8) 0deg, transparent 200deg)",
          borderRadius: "50%",
        }}
        animate={{ rotate: 360 }}
      ...
      <motion.div
        ...
        style={{
          background:
            "conic-gradient(from 180deg, rgba(34,197,94,0.4) 0deg, transparent 160deg)",
          borderRadius: "50%",
        }}
        animate={{ rotate: -360 }}
...
function ProgressBar({ progress }: { progress: number }) {
  return (
    <div className="w-full max-w-xs h-1.5 rounded-full bg-white/5 overflow-hidden">
      <motion.div
        className="h-full rounded-full bg-gradient-to-r from-green-600 via-green-400 to-emerald-300"
