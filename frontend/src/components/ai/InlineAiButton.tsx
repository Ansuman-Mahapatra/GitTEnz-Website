...
export function InlineAiButton({ rect, onClick }: InlineAiButtonProps) {
  ...
  return (
    <motion.button
      ...
      className="fixed z-[9999] w-9 h-9 rounded-full bg-primary text-primary-foreground shadow-lg shadow-primary/30 flex items-center justify-center hover:bg-primary/90 hover:scale-110 transition-transform cursor-pointer glow-green"
      style={{
        top: clampedTop,
        left: clampedLeft,
      }}
