                                ...
                                <CardContent className="flex-1 overflow-auto p-2">
                                    {treeLoading ? (
                                        ...
                                        <div className="space-y-1">
                                            {fileTree?.tree?.map((item: any) => (
                                                <div
                                                    key={item.path}
                                                    className={`flex items-center gap-2 px-2 py-1.5 rounded-md text-sm cursor-pointer hover:bg-accent ${selectedFile?.path === item.path ? "bg-accent text-accent-foreground" : "text-muted-foreground"}`}
                                                    onClick={() => handleFileClick(item)}
                                                >
                                                    {item.type === "tree" ? <Folder className="w-4 h-4 text-primary" /> : <File className="w-4 h-4" />}
